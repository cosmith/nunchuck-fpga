...
XELAB_1="Z:/Option ISIA/Wang-Smith/Nunchuck/Nunchuck.sim/sim_1/impl/func/NunchuckTest.prj"

ExecStep xelab -m64 --debug typical --relax -L xil_defaultlib -L unisims_ver -L secureip --snapshot NunchuckTest_func_impl --prj "$XELAB_1"   xil_defaultlib.NunchuckTest   xil_defaultlib.glbl
